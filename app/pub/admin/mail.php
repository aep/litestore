    ...
    switch ($_POST['customers_email_address']) {
      ...
      default:
        if (is_numeric($_POST['customers_email_address'])) {
          ...
          $sent_to_query = xtc_db_query("select customers_status_name from " . TABLE_CUSTOMERS_STATUS . " WHERE customers_status_id = '" . $_POST['customers_email_address'] . "' AND languages_id='" . $_SESSION['languages_id'] . "'");
...
//    $customers_statuses_array = xtc_get_customers_statuses();
    $customers_statuses_array = xtc_db_query("select customers_status_id , customers_status_name from " . TABLE_CUSTOMERS_STATUS . " WHERE languages_id='" . $_SESSION['languages_id'] . "' order by customers_status_name");

...
<?
    ...
    $result = xtc_db_query("SELECT * FROM ".TABLE_CATEGORIES." c, ".TABLE_CATEGORIES_DESCRIPTION." cd WHERE c.categories_id = cd.categories_id and cd.languages_id = '" . $_SESSION['languages_id'] . "' ORDER BY c.categories_id");

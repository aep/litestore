<?php
  ...
  define('MODULE_PAYMENT_UOS_KREDITKARTE_KEY_DESC','Den Security-Key den Sie von U O S zur Segnierung der Datenžbertragung bekommen haben.');
  define('MODULE_PAYMENT_UOS_KREDITKARTE_CURRENCY_DESC','Die W?hrung die Sie bei U O S nutzen m?chten.');
  define('MODULE_PAYMENT_UOS_KREDITKARTE_ZONE_DESC','Wenn Sie hiereine Zone einstellen wird diese Payment nur fžr diese genutzt werden.');
  ...
  define('MODULE_PAYMENT_UOS_KREDITKARTE_DEMO_TITLE','Demo Modus auf True bedeutet, dass Sie žber unsere Testumgebung buchen.');

...
define('WARNING_CONFIG_FILE_WRITEABLE', 'Warnung: ReStore kann in die Konfigurationsdatei schreiben: ' . dirname($HTTP_SERVER_VARS['SCRIPT_FILENAME']) . '/includes/configure.php. Das stellt ein m&ouml;gliches Sicherheitsrisiko dar - bitte korrigieren Sie die Benutzerberechtigungen zu dieser Datei!');
...
define('WARNING_SESSION_DIRECTORY_NOT_WRITEABLE', 'Warnung: ReStore kann nicht in das Sessions Verzeichnis schreiben: ' . xtc_session_save_path() . '. Die Sessions werden nicht funktionieren bis die richtigen Benutzerberechtigungen gesetzt wurden!');
...
define('NOT_ALLOWED_TO_SEE_PRICES','Sie k&ouml;nnen als Gast keine Preise sehen.');
...
define('SUB_TITLE_SUB_TOTAL', 'Warenwert:');

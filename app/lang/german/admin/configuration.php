...
define('RCS_EMAIL_FRIENDLY_DESC', 'Wenn <b>true</b> dann, wird der Name des Kunden im Gru� verwendet. Wenn <b>false</b> dann, wird ein generischer Gru� verwendet.');
define('RCS_EMAIL_COPIES_TO_TITLE', 'E-Mail Kopien an');
define('RCS_EMAIL_COPIES_TO_DESC', 'Wenn Sie eine Kopie der durch dieses Modul generierten E-Mail die Sie an den Kunden senden w�nschen, tragen Sie eine eMail Adresse hier ein. Wenn leer, werden keine Kopien gesendet.');
define('RCS_SHOW_ATTRIBUTES_TITLE', 'Zeige Produktoptionen');
define('RCS_SHOW_ATTRIBUTES_DESC', 'Kontrollanzeige der Einzelteilattribute.<br><br>Einige Produkte haben Attribute (Optionen/Zubeh�r).<br><br>Stellen Sie auf <b>true</b> wenn sie Attribute anzeigen m�chten, wenn nicht, stellen sie auf <b>false</b>.');
define('RCS_CHECK_SESSIONS_TITLE', 'Ignoriere Kunden mit aktiven Sessions');
define('RCS_CHECK_SESSIONS_DESC', 'Wenn sie diese Funktion w�nschen, Kunden mit aktiven Sessions nicht anzuzeigen (ie, warscheinlich gerade noch am shoppen) stellen sie auf <b>true</b>.<br><br>Stellen sie dies auf <b>false</b> werden standardm�ssig Sessions ignoriert, verwendet weniger Ressourcen.');
...
define('RCS_UNCONTACTED_COLOR_DESC', 'Farbe mit der unkontaktierte Kunden in der Liste angezeigt werden sollen.<br><br>Unkontaktierte Kunden werden nur solange in dieser Farbe angezeigt, wie sie <i>nicht</i> mit diesem Modul per eMail kontaktiert wurden.');
...
define('RCS_MATCHED_ORDER_COLOR_TITLE', 'Farbe zusammenpassende Auftr�ge');
define('RCS_MATCHED_ORDER_COLOR_DESC', 'Farbe f�r Eintr�ge, die zusammenpassen k�nnten .<br><br>Eine Eintragung wird mit dieser Farbe gekennzeichnet, wenn ein Auftrag eins oder mehr eines Einzelteils in dem verlassenen Warenkorb enth�lt <b>und</b> entweder die Kundenemailadresse oder Datenbank ID des Warenkorbs zusammenpasst.');
define('RCS_SKIP_MATCHED_CARTS_TITLE', 'Ignorieren von zusammenpassenden Warenk�rben');
define('RCS_SKIP_MATCHED_CARTS_DESC', 'Um zusammenpassende Warenk�rbe anzuzeigen, stellen Sie auf <b>true</b>.<br><br>Stellen Sie auf <b>false</b> wenn Sie zusammenpassende Warenk�rbe, zusammen mit dem passenden Auftrags-Status nicht anzeigen wollen.<br><br>Schauen Sie in die Dokumentation f�r mehr Details.');

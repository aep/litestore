...
switch ($_GET['action']) {
	...
	case 'product' :
		if (isset ($_GET['id'])) {
			$product_query = xtc_db_query("SELECT products_url FROM ".TABLE_PRODUCTS_DESCRIPTION." WHERE products_id='".(int) $_GET['id']."' and languages_id='".(int) $_SESSION['languages_id']."'");

...
// * DIR_WS_* = Webserver directories (virtual/URL)
  define('HTTP_SERVER', 'http://'.$_SERVER["SERVER_NAME"]); // eg, http://localhost or - https://localhost should not be empty for productive servers
...
// define our database connection
  ...
  define('DB_SERVER_USERNAME', '<<RSTI_UNIXUSER>>');
  define('DB_SERVER_PASSWORD', '<<RSTI_PWD>>');
  define('DB_DATABASE', '<<RSTI_UNIXUSER>>');

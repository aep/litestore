...
echo xtc_draw_hidden_field(xtc_session_name(), xtc_session_id());
  ...
  $query = "SELECT * FROM  ".TABLE_PRODUCTS_DESCRIPTION."  where products_id LIKE '%' AND languages_id = '" . $_SESSION['languages_id'] . "' ORDER BY products_name ASC";
...
<?php
  ...
  $copy_query = xtc_db_query("SELECT pd.products_name, pd.products_id FROM  ".TABLE_PRODUCTS_DESCRIPTION."  pd, ".TABLE_PRODUCTS_ATTRIBUTES." pa where pa.products_id = pd.products_id AND pd.products_id LIKE '%' AND pd.languages_id = '" . $_SESSION['languages_id'] . "' GROUP BY pd.products_id ORDER BY pd.products_name ASC");
